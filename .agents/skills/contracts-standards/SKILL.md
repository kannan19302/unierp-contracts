...
description: Authoritative standards, architectural boundaries, coding anatomy, and verification gates for unierp-contracts.
version: 1.0.0
author: UniERP Architecture Governance
---

# UniERP Contracts Layer — AI Agent Guidance & Project Skill

This skill governs all code modification, analysis, and testing within `unierp-contracts` (**Layer L0: Contracts**). Every AI agent and software engineer working in this repository MUST follow these rules without exception.

---

## 🏛️ 1. Architectural Position & Boundary Rules

- **Repository**: `unierp-contracts`
- **Layer**: **L0 (Contracts)**
- **Package Identity**: `@kannan19302/contracts`
- **Allowed Inbound Callers**: All Layers L1 to L7
